...
/**
 * Clientbound {@code chunk_batch_finished}; reports the number of chunks in the batch.
 */
public class ChunkBatchEndPacket implements MinecraftPacket {

  private int batchSize;

  public ChunkBatchEndPacket() {
  }

  public ChunkBatchEndPacket(int batchSize) {
