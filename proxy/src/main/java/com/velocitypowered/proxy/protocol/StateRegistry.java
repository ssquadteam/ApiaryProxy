  ...
  PLAY {
    {
      ...
      clientbound.register(
          RespawnPacket.class,
          RespawnPacket::new,
          map(0x07, MINECRAFT_1_7_2, false),
          map(0x33, MINECRAFT_1_9, false),
          map(0x34, MINECRAFT_1_12, false),
          map(0x35, MINECRAFT_1_12_1, false),
          map(0x38, MINECRAFT_1_13, false),
          map(0x3A, MINECRAFT_1_14, false),
          map(0x3B, MINECRAFT_1_15, false),
          map(0x3A, MINECRAFT_1_16, false),
          map(0x39, MINECRAFT_1_16_2, false),
          map(0x3D, MINECRAFT_1_17, false),
          map(0x3B, MINECRAFT_1_19, false),
          map(0x3E, MINECRAFT_1_19_1, false),
          map(0x3D, MINECRAFT_1_19_3, false),
          map(0x41, MINECRAFT_1_19_4, false),
