 ...
 */
 ...
 public enum StateRegistry {
   ...
   <P extends MinecraftPacket> void clientbound(final Class<P> clazz, final Supplier<P> factory, final Consumer<PacketMapper> mapper) {
     this.clientbound.register(clazz, factory, mapper);
   }
 
   <P extends MinecraftPacket> void serverbound(final Class<P> clazz, final Supplier<P> factory, final Consumer<PacketMapper> mapper) {
   ...
   public static class PacketRegistry {
     ...
     <P extends MinecraftPacket> void register(final Class<P> clazz, final Supplier<P> factory, final Consumer<PacketMapper> mapper) {
