...
public final class CompressorUtils {
   ...
   * measured latency) never triggers. The formula matches libdeflate's
   * {@code libdeflate_zlib_compress_bound}: roughly {@code input + input/2 + 128}
   * of structural overhead for the dominant sub-64KiB range.
   *
